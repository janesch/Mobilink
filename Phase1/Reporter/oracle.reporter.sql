...
--       All Rights Reserved
-------------------------------------------------------------------------------
-- For use with the Netcool/OMNIbus Gateway for Oracle running in 'reporter' 
-- mode.
-------------------------------------------------------------------------------
...
--   (3) At the Sqlplus prompt, run this script eg    @oracle.reporter.sql

--  EXAMPLE      SQLPLUS>  @oracle.reporter.sql
--------------------------------------------------------------------------------

-- User tablespace.
DROP TABLESPACE REPORTER INCLUDING CONTENTS;
CREATE TABLESPACE REPORTER
DATAFILE 'REPORTER_DATA' SIZE 256K
...
TEMPFILE 'REPORTER_TEMP_DATA' SIZE 256K
...
(
       ...
       X733ProbableCause NUMBER(4)	NULL,
       X733SpecificProb  VARCHAR(64)	NULL,
       X733CorrNotif     VARCHAR(255)	NULL,
       DeletedAt	 DATE		NULL,
       OriginalSeverity	 NUMBER(16)	NULL,
       ServerName	 VARCHAR2(64) 	NOT NULL,
       ServerSerial	 NUMBER(16)	NOT NULL,
